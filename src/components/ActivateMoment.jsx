  ...
  return (
    <div className='my-14 w-full max-w-[908px] mx-auto'>
      ...
      <div className='my-4 flex flex-col gap-2'>
       <header className='font-poppins text-[29.325px] font-semibold leading-[38.12px] text-based' >FEATURED PLAYS</header>
      ...
      <div className='my-4 flex flex-col gap-2'>
        <header className='font-poppins text-[29.325px] font-semibold leading-[38.12px] text-based' >SEE HOW REPEAT CAN HELP YOU</header>
        <div className='flex gap-8'>
