    ...
    <section className='min-h-[492px] flex items-end bg-custom-yellow'>
      <div className="hero flex flex-col gap-4 w-full max-w-[1000px] mx-auto pb-[45px] ">
        ...
        <div className="flex flex-col gap-4 w-full max-w-[665px]">
            <button className=" text-left font-montserrat flex gap-3 items-center text-based font-semibold text-[34px] py-[17px] px-[34px] bg-white border border-based rounded-full w-full max-w-[665px]"> <FaArrowRight size={17} /> GET STARTED</button>
